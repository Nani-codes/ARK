...
export default function ProfessionalsScreen() {
  ...
  return (
    <View style={styles.container}>
      <AppHeader title="Find Professionals" showBack showLocation={false} />
          ...
          professionals.map((pro) => (
            <View key={pro.id} style={styles.card}>
              ...
              <View style={styles.cardBody}>
                ...
                {pro.contractorId ? (
                  <Text style={styles.meta}>ID: {pro.contractorId}</Text>
                ) : null}
                {pro.professionalBio ? (
...
const styles = StyleSheet.create({
  ...
  trade: { ...typography.labelMd, color: colors.secondary, marginTop: 2 },
  meta: { ...typography.labelMd, color: colors.onSurfaceVariant, marginTop: 4 },
  bio: { ...typography.bodyMd, color: colors.onSurfaceVariant, marginTop: spacing.unit2 },
  callBtn: {
