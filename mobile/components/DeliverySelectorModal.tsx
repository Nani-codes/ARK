...
export function DeliverySelectorModal({ visible, onClose }: Props) {
  ...
  const selectedId = useAddressStore((s) => s.selectedId) || addresses.find((a) => a.isDefault)?.id || addresses[0]?.id || null;
      ...
      <Pressable style={styles.backdrop} onPress={onClose}>
        <Pressable style={styles.sheet} onPress={(e) => e.stopPropagation()}>
          <View style={styles.header}>
            ...
            <Pressable onPress={onClose} style={styles.closeBtn} accessibilityRole="button" accessibilityLabel="Close selector">
